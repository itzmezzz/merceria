...
<title>Editar Categoría - Mercería Victoria</title>
...
<form action="{{ route('actualizar_categoria', $categoria->id) }}" method="POST" class="space-y-6">
@csrf
@method('PUT')
...
name="descripcion"
rows="3"
class="col-span-3 px-4 py-2 rounded-lg bg-slate-700 border border-slate-600 focus:outline-none focus:border-green-500">{{ $categoria->descripcion }}</textarea>
